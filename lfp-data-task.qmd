  ...
  html:
    ...
    other-links:
      - text: Data Task Instructions
        icon: file-pdf
        href: https://github.com/george-rao/lfp-data-task/blob/944a92a85abc724730b8fe4a82e0f4f5dbd98c52/instructions/predoc_data_task_2024.pdf
        target: _blank
    ...
    code-links:
      ...
      - text: Quarto File
        icon: file-code
        href: https://github.com/george-rao/lfp-data-task/blob/944a92a85abc724730b8fe4a82e0f4f5dbd98c52/lfp-data-task.qmd
        target: _blank
    toc: true
    toc-depth: 2
    fig-asp: 0.618
...
This page is based on a "data task" I completed for a workshop related to careers in social science research. I am including a link to this page as a coding sample in my applications to pre-doctoral research assistantships.
...
## Question 6
> Create an alternative measure of labor force participation that excludes individuals from the labor force if they are self-employed in their main job (lfp = 0 if self-employed in main job). Using the new measure, describe how labor force participation for college-educated and not college-educated women has evolved since 1994.
