...
women_over_25 |>
  summarize(
    .by = c(race),
    lfp_rate_1994 = weighted.mean(if_else(year == 1994, lfp_lgl, NA), wgt,
                                  na.rm = TRUE),
    lfp_rate_2024 = weighted.mean(if_else(year == 2024, lfp_lgl, NA), wgt,
                                  na.rm = TRUE),
...
women_over_25 |>
  summarize(
    ...
    lfp_rate_2023 = weighted.mean(if_else(year == 2023, lfp_lgl, NA), wgt,
                                  na.rm = TRUE),
